...
The specific proving method is specified on the intent. Users who create intents must understand the proving method used in that intent, and the trust assumptions that come along with that proving method. Safenet itself does not ensure the safety of proofs.
