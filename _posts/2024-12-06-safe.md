...
Safenet is unopinionated about proving methods. Safenet supports a pluggable architecture which can support many different types of proofs. The proving mechanism is defined in the intent. This allows users to chose a proving mechanism that works for them.
